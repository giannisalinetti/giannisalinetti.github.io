---
title: "The Incomparable Importance of Listening"
...
Sometimes projects fail due to planning issues (and we will discuss this topic in another blog post), but very often the reason lies in a lack of **listening** that prevents us from understanding the real needs expressed by our stakeholders.
...
Does it resonate? This pattern is very similar to how an LLM (Large Language Model) works, especially [**Transformer**](https://huggingface.co/docs/transformers/en/index) based ones. [Attention](https://arxiv.org/abs/1706.03762) mechanisms that pick up what matters, frame them in context and produce a response that is conditioned by the input. Yes, this is a very trivial interpretation, but it's interesting to see the parallelism that is the key to building a model that acts and behaves like a human.

There is only one HUGE difference: **emotions**. We, as humans, filter and enrich everything with our emotions, and they are driven by our experiences and our inner nature.
One could say this is the last milestone that makes us different from machines, together with empathy and self-awareness (gifts also denied to some human beings, indeed).

Emotions play a huge role in human listening. They can amplify content, drive our attention or annihilate it if we are afraid.
Learning to Listen (with a capital L) is also the art of learning to understand, accept and manage our emotions, balance our inner world and the outer world. It's not a coincidence that Mindfulness practices involve active listening, beginning from one's own breath, to focus and expand awareness.
...
Spotting the signals, in my opinion, needs reflection work, as they are not the same for everybody. For example, I noticed that when it happens my breathing changes, I lose focus and attention, and I feel like I'm in a bubble.
...
Imagine yourself delivering a solution to a customer, you prepared slides, calculations of ROI, architecture high-level designs and when you meet your people, you just start talking about your own stuff without checking other people's reactions or understanding their needs. 
You don't even notice that you are losing your audience during the presentation.
...
Are there any techniques that we can develop to improve our listening skills? Sure, we are going to describe some here, with the clear intent of **not providing a script**, but a set of good habits to be developed and slowly incorporated into our daily behavior.
I also have to be totally honest and admit that these are things I still practice myself, with mixed results, but it's good to have the chance to try.
...
- [**Leadership Presence: Dramatic Techniques To Reach Out, Motivate, And Inspire**](https://www.amazon.com/Leadership-Presence-Kathy-Lubar/dp/1592400868/ref=sr_1_1?crid=1OA00DVN10OSI&dib=eyJ2IjoiMSJ9.loZywCN62g12dGPdLS3bnP1tXPR0D89Tdt7Qcpr3hG8HqAjbgJ10vhzhiKEGcWdruD5A3ikRZl50g9wTdZ6IInXogh986tbw-x1ptbxTg88Lrm9j6BzzdYNtiMdZUgKV0Q7NGn_8ES3N4rYhqtMcRFGNuAIWTZMvX_ks5HoMuOKgqcvHh0DzFeWW2SwPsfL89RthGuzAYjgJjAr71YJWZIevm3qX4XEtxb0mXQt-NjA.DmbnqDS9KY5wTcmji63QD3v9ZIAMV2ek__AksB3jdmo&dib_tag=se&keywords=leadership+presence&qid=1772660424&sprefix=leadership+presenc%2Caps%2C246&sr=8-1)  
  Authors: Belle Linda Halpern, Kathy Lubar  
  ISBN: 978-1592400867

- [**The Miracle of Mindfulness**](https://www.amazon.com/Miracle-Mindfulness-Introduction-Practice-Meditation/dp/0807012394/ref=sr_1_1?crid=V0DZDPJKVXRL&dib=eyJ2IjoiMSJ9.HCfISDM2eRqsCxrcCDZPe208istlNjhHxZo8bh9F1Fg0Q7a8V7NXITXPXQmegRBlq-2ULl6YTfp1oy01nOd-7j30sFr81Sk6U-YF_K3UubQbFkHwvCYmN87GKdTVSjgyuW_DASiS1yvP63MCnpRUlVzkMwfPO7v3aVDZNulK2RfdO4zpk8QAdq59Amp_aBieki2elThBbH7gEL8fYAyPfpnsT0PfBmPa7RJsgVwJzNQ.fE2ci4AnjLjqNDedib4dLQ9j21hHF9t_6vkFqXaGMAk&dib_tag=se&keywords=the+miracle+of+mindfulness+thich+nhat+hanh&qid=1772660328&sprefix=the+miracle+of+minf%2Caps%2C245&sr=8-1)  
  Author: Thich Nhat Hanh  
  ISBN: 978-1846046407

- [**The Next Conversation**](https://www.amazon.com/Next-Conversation-Argue-Less-Talk/dp/0593718720/ref=sr_1_1?crid=3SJF4MWNHOZ34&dib=eyJ2IjoiMSJ9.uAYL5YrmWDLo1z6pjB5yYVTIQ95esMGvivD3FJJAvmXhQS5Aih5IQmxEoMRzKAKStnkqxyU4NAsewpkNYN7jrp-FlQReKG38FroMvTG6NeJRR9VTwuLTVNy-3e5m3-UQRbm5sYuIu1T_vEsKHUykpUbTh2_pAdkEtmS9gPVgdAJjXhjBPGQEsS6HvAoVJt4Oty9t2KViYThe2_RYau5FSZj_r74Gh8vwisyZS_cLhk4.mf5HNT7lp7tSbWPOEQd2gUJPrn4SZMFwBA9_cRwBEPs&dib_tag=se&keywords=the+next+conversation&qid=1772660246&sprefix=the+next+conversation%2Caps%2C250&sr=8-1)  
